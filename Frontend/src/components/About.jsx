          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-zinc-300 mb-8">
                Your ultimate online coding environment designed for students
                and developers
              </p>

              <div className="prose prose-invert max-w-none">
                <p className="text-zinc-300">
                  PIXELCODE is an innovative online code IDE created by
                  students, for students. We understand the challenges of
                  learning to code, which is why we've built a platform that
                  combines powerful features with an intuitive interface to make
                  coding accessible and enjoyable for everyone.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="grid gap-6">
                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                  ...
                  <p className="text-zinc-300">
                    Choose between Guest mode for quick coding sessions or
                    Authentication mode with a complete file system to save and
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                  ...
                  <p className="text-zinc-300">
                    Our built-in AI assistant helps you write better code, fix
                    errors, and learn programming concepts faster than ever
                    before.
                  </p>
                </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                  ...
                  <p className="text-zinc-300">
                    Personalize your coding environment with themes and language
                    preferences. Generate shareable links to collaborate with
                    classmates and instructors effortlessly.
                  </p>
                </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6">
                  ...
                  <p className="text-zinc-300">
                    From JavaScript and Python to HTML, CSS, and beyond —
                    PIXELCODE supports all major programming languages with
