...
const ResetPassword = () => {
  ...
  const { backendurl, isLoggedin, getUserData, userData, setuserData } =
  ...
  return (
    <>
      <div className="flex text-white justify-center items-center min-h-screen bg-gradient-to-b from-blue-950 to-blue-900">
        {!isemailsent && (
          <form
            className="rounded-2xl p-8 flex flex-col items-center shadow-xl w-96 text-sm border  border-slate-700 bg-[#151c22]"
            onSubmit={handleemailsub}
          >
            <h2 className="text-2xl font-semibold text-center mb-4">
              Reset Password
            </h2>
            <p className="text-center mb-6 text-blue-0 text-lg">
