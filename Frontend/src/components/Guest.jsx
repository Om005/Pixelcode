...
const Dashboard = () => {
  ...
  const handleFileDrop2 = (e) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        sessionStorage.setItem("code", event.target.result);
      };
      reader.readAsText(file);
    }
  };
  ...
  const [slink, setslink] = useState(
    sessionStorage.getItem("slink") ||
      "https://pixelcode-nine.vercel.app/guest/"
  );
  const [haveid, sethaveid] = useState(
    sessionStorage.getItem("haveid") === "true" || false
  );
...
<div className="flex gap-2">
            ...
            {showshare && !haveid && (
              ...
              >
                <div
                  className="w-full max-w-md transform rounded-lg bg-gray-800 shadow-xl transition-all animate-in zoom-in-95 duration-200 p-6"
                ...
                >
                  ...
                  <p className="text-sm text-gray-100 border border-gray-600 bg-gray-700 rounded-md px-3 py-2 mb-4 overflow-hidden whitespace-nowrap text-ellipsis">
                    {slink}
                  </p>

                  <button
                    onClick={() => handleshare()}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-500 sharef text-white font-medium rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-colors duration-200"
                  >
                    <img
                      src="./svgs/link.svg"
                      className="h-5 w-5 invert rotate-45"
                      alt="Link"
                    />
                    Generate Link
                  </button>
              ...
              >
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => handlecopy()}
                      className="flex-1 px-4 py-2 bg-blue-500 sharef text-white font-medium rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-colors duration-200"
                    >
                      Copy Link
                    </button>
                    <button
                      onClick={() => handleupdate()}
                      className="flex-1 px-4 py-2 bg-blue-500 updatef sharef text-white font-medium rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-800 transition-colors duration-200"
                    >
                      Update
                    </button>
                  </div>
          ...
          <div className="h-12 w-full rounded-lg  bg-gray100 dak:bg-neutral-800 flex justify-between mr-9 gap-1 items-center">
            ...
            {!isLoggedin && (
              ...
              >
                <img src="./imgs/login.png" className="w-5 invert" alt="" />{" "}
                Sign in
              </Link>
            )}
            {isLoggedin && (
              <Link
                to={"/links"}
                className="px-6 m hover:translate-x-1 duration-200 py-1 text-lg bg-[#0BA6ECCC] text-white flex gap-2 items-center rounded-lg hover:bg-sky-600 focus:outline-none w-full md:w-auto"
              >
                Links
              </Link>
            )}
