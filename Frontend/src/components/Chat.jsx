  ...
  const getAIResponse = async (message) => {
    try {
      ...
      if (isrefer === false || fname === "") {
        msg = `You must write the full name of the language (like "C++" instead of "cpp") in your response.

User says:

${message}`;
      } else {
        msg = `If the user refers to "this code" or "this file" without sharing specific code, assume this as the context:
...
- Write full language names (e.g., "C++" instead of "cpp")

- Format all code with triple backticks
...
${message}`;
      ...
      const rsp = await axios.post(
        import.meta.env.VITE_BACKEND_URL + "/api/chat/response",
        { message: msg }
      );
  ...
  const Pre = ({ children, ...props }) => {
    ...
    return (
      <div className="relative group">
        <button
          onClick={handleCopy}
          className="absolute top-2 right-2 z- p-2 bg-gray-700/80 hover:bg-gray-600/80 rounded-md transition-opacity duration-200"
          title="Copy code"
        >
          {copied ? (
  ...
  return (
    <div
      className={
        darkMode
          ? "bg-[#09090B] overflow-hidden montserrat relative"
          : "bg-gray-100 overflow-hidden montserrat relative"
      }
      style={{ height: "90vh" }}
    >
      <div className="absolute top-24 flex justify-center z-10 w-[80vw]">
        {isrefer && fname !== "" && (
          <div className="bg-[#1A1A1F] relative ml-60 text-[#9CA3A6] flex gap-2 rounded-lg p-3">
            <img
              onClick={() => {
                setisrefer(false);
              }}
              src="./svgs/cross.svg"
              className="cursor-pointer absolute w-5 -right-1 bg-[#2d2d34] rounded-full -top-1 p-1"
              alt=""
            />
        ...
        <div className="w-[50%] h-14 rounded-xl mt-10 bg-gradient-to-r from-indigo-900 to-purple-900 text-white flex justify-between items-center px-6 border border-indigo-700/30">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <span className="absolute left-0 -bottom-0.5 h-0.5 bg-white w-0 group-hover:w-[90%] transition-all duration-200 ease-out"></span>
            </Link> */}
            ...
            >
              ...
              <span className="absolute left-0 -bottom-0.5 h-0.5 bg-white w-0 group-hover:w-[80%] transition-all duration-200 ease-out"></span>
            </Link>
            ...
            {DeletePopup && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
                <div
                  className={`bg-${
                    darkMode ? "[#18181b]" : "white"
                  } rounded-xl shadow-lg p-8 bg-[#272822] w-80 flex flex-col items-center`}
                >
                  ...
                  <div className="flex space-x-3">
                    <button
                      ...
                      className={`px-4 dcbtn py-2 rounded-lg font-medium transition-all duration-150 ${
                        darkMode
      ...
      <div
        ...
        } h-[90vh] flex flex-col p-6 overflow-y-auto`}
      >
        {messages.length === 0 ? (
            ...
            {messages.map((message) => (
              ...
              >
                ...
                >
                  ...
                  {message.sender === "ai" && (
                    <div className="relative text-sm px-4 py-3 rounded-xl bg-[#212121] sm:text-base break-words whitespace-pre-wrap">
                      <img
                        onClick={() => {
                        ...
                        src="./svgs/copy.svg"
                        className="invert copy absolute -bottom-12 mt-1 left-1 cursor-pointer hover:bg-[#D8D7DD] p-2 rounded-lg"
                        alt=""
                      />
                ...
                {message.sender === "user" && (
                  <span className="h-fit px-2 py-2 rounded-full bg-[#312E81] -mr-7 ml-4">
      ...
      <div className="fixed bottom-4 transition-all duration-200 w-full flex justify-center items-center">
        <div className="relative w-[70%] px-4">
          <input
            ...
            className={`${
              darkMode
                ? "bg-[#1a1a1f] border-[#27272e]"
                : "bg-white border-gray-300"
            } w-full focus:border-none outline-none duration-200 focus:outline-indigo-600 h-16 rounded-xl border pl-4 pr-12 ${
              darkMode ? "text-white" : "text-gray-800"
            }`}
