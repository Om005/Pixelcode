...
return (
    <div
        className={cn(
            "mx-auto flex w-full max--7xl flex-1 flex-col overflow-hidden rounded-md border md:flex-row border-neutral-700 bg-neutral-800",
            "h-[100vh]"
        )}>
        ...
        <div className="flex gap-2">
          {[...new Array(4)].map((i, idx) => (
            <div
              ...
              className="h-20 w-full animate-pulse rounded-lg bg-neutral-800"></div>
          ))}
        </div>
        <div className="flex flex-1 gap-2">
          {[...new Array(2)].map((i, idx) => (
            <div
              ...
              className="h-full w-full animate-pulse rounded-lg bg-neutral-800"></div>
          ))}
        </div>
      </div>
    </div>
